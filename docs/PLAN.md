...
## Phase 4 — `query` · `graph` · 릴리스 (완료)

- [x] `query <channel|method>` — cartograph 스키마 골격
...
| 3 되돌려 주기 | 핵심 완료 | 실제 cartograph·dartograph 생산 출력부터 dead·explain까지 왕복 검증. 공개 Flutter 앱 도그푸딩 남음 |
